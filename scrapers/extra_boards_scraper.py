...
class ExtraBoardsScraper(BaseScraper):
    ...
    BOARD_CONFIGS = [
        {
            "name": "SecretCV",
            # Verified URL (May 2025) — old /is-ilanlari?keyword=staj returns 410
            "url": "https://www.secretcv.com/is-ilanlari/staj-is-ilanlari",
            "card_sel": ".cv-job-box",
            "title_sel": "h3, h4, h2, .job-title, [class*='title']",
            "company_sel": ".company, [class*='company'], [class*='firma']",
            "location_sel": "[class*='location'], [class*='sehir'], [class*='city']",
            "link_sel": "a[href]",
